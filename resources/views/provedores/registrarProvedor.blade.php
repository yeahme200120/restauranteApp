...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Registrar Provedor') }}</div>

                    <div class="card-body">
                        <form method="POST" action="/createProvedor">
                            @csrf
                            <div class="row">
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="nombre_provedor" type="text"
                                        ...
                                        value="{{ old('nombre_provedor') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="direccion" type="text"
                                        ...
                                        value="{{ old('direccion') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="correo" type="email"
                                        ...
                                        value="{{ old('correo') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="nombre_empresa" type="text"
                                        ...
                                        value="{{ old('nombre_empresa') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="razon_social" type="text"
                                        ...
                                        value="{{ old('razon_social') }}" required autocomplete="name" autofocus>
