        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/createProducto">
                            @csrf
                            <div class="row">
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="nombre_producto" type="text"
                                        ...
                                        value="{{ old('nombre_producto') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="precio_compra" type="number" step=".01" min="1"
                                        ...
                                        value="{{ old('precio_compra') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="precio_venta" type="number" step=".01" min="1"
                                        ...
                                        value="{{ old('precio_venta') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="stock" type="number" step=".01" min="1" class="form-control @error('stock') is-invalid @enderror" name="stock"
                                        value="{{ old('stock') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col--12 col-md-6 p-1 text-center">
                                    ...
                                    <input id="iva" type="number" step=".01" min="0"
                                        ...
                                        value="{{ old('iva') }}" required autocomplete="name" autofocus>
