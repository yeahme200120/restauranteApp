                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-1 text-center text-success" data-toggle="tooltip" data-placement="left" title="Registrar nueva empresa">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center">{{$empresa->estatus_empresa}} </td>
                                        <td>
                                            <div class="row justify-content-center">
                                                <div class="col-1" data-toggle="tooltip" data-placement="top" title="Editar empresa ">
                                                    <i class="fa fa-pencil-square text-warning" aria-hidden="true"></i>
                                                </div>
                                                <div class="col-1" data-toggle="tooltip" data-placement="bottom" title="Eliminar empresa">
