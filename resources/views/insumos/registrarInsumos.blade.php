...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form method="POST" action="/createInsumos">
                    <div class="card">
                        <div class="card-header">{{ __('Registrar Insumos') }}</div>
                                ...
                                <div class="row">
                                    <div class="col--12 col-md-6 p-1 text-center">
                                        ...
                                        <input id="descripcion" type="text"
                                            ...
                                            value="{{ old('descripcion') }}" required autocomplete="name" autofocus>
                                    ...
                                    <div class="col--12 col-md-6 p-1 text-center">
                                        ...
                                        <input id="precio_unitario" type="number" step=".01" min="1"
                                            ...
                                            value="{{ old('precio_unitario') }}" required autocomplete="name" autofocus>
