            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/actualizarEmpresa" method="POST">
                            @csrf
                            <div class="row">
                                <input class="form-control  @error('codigo_postal') is-invalid @enderror" type="hidden"
                                        id="id" value="{{ $empresa->id }}" name="id" required>
                                        @error('id')
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input class="form-control  @error('codigo_postal') is-invalid @enderror" type="number"
                                        id="codigo_postal" value="{{ $empresa->codigo_postal }}" name="codigo_postal" required>
                                    @error('codigo_postal')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('pais') is-invalid @enderror" type="text"
                                        id="pais" value="{{ $empresa->pais }}" name="pais" required>
                                    @error('pais')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('ciudad') is-invalid @enderror" type="text"
                                        id="ciudad" value="{{ $empresa->ciudad }}" name="ciudad" required>
                                    @error('ciudad')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('domicilio_fiscal') is-invalid @enderror"
                                        type="text" value="{{ $empresa->domicilio_fiscal }}" name="domicilio_fiscal"
                                        required>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('giro') is-invalid @enderror" type="text"
                                        value="{{ $empresa->giro }}" name="giro" required>
                                    @error('giro')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('nombre_empresa') is-invalid @enderror"
                                        type="text" value="{{ $empresa->nombre_empresa }}" name="nombre_empresa" required>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('razon_social') is-invalid @enderror" type="text"
                                        value="{{ $empresa->razon_social }}" name="razon_social" required>
                                    @error('razon_social')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <input class="form-control  @error('RFC') is-invalid @enderror" type="text"
                                        value="{{ $empresa->RFC }}" name="RFC" required>
                                    @error('RFC')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 p-1">
                                    ...
                                    <select id=""
                                        ...
                                        value="{{ $empresa->estatus_empresa }}" name="estatus_empresa">
